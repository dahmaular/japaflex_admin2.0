  ...
  return (
    <aside className="sidebar">
      <div className="items-container">
        <div>
          ...
          <nav className="navigation">
            <ul className="nav-list">
              ...
              <li
                className={`nav-item ${openDropdowns.features ? "expanded" : ""} ${isPathActive("/features") ? "active" : ""
                  }`}
              >
                <div
              ...
              <li
                className={`nav-item ${openDropdowns.userManagement ? "expanded" : ""
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`chevron ${openDropdowns.userManagement ? "open" : ""
                      }`}
                  >
                    ›
                  </span>
              ...
              <li
                className={`nav-item ${isPathActive("/admin-management") ? "active" : ""
                  }`}
              >
              ...
              <li
                className={`nav-item ${isPathActive("/ads-management") ? "active" : ""
                  }`}
              >
              ...
              <li
                className={`nav-item ${isPathActive("/content-management") ? "active" : ""
                  }`}
              >
              ...
              <li
                className={`nav-item ${openDropdowns.communication ? "expanded" : ""
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`chevron ${openDropdowns.communication ? "open" : ""
                      }`}
                  >
                    ›
                  </span>
              ...
              <li
                className={`nav-item ${isPathActive("/system-settings") ? "active" : ""
                  }`}
              >
        ...
        <div onClick={handleLogout} className="nav-item-main pointer">
          <div className="icon-container">
            <LogOut />
          </div>
          <span>Logout</span>
